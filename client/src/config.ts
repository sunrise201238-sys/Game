...
export const MAPS: MapDefinition[] = [
  ...
  },
  {
    id: 'twin-bridge',
    name: 'Twin Bridge',
    description: 'A single elevated bridge spans deep water — hold the center or be swept aside.',
    width: 960,
    height: 540,
    lakes: [
      { x: 0, y: 80, width: 320, height: 360 },
      { x: 640, y: 80, width: 320, height: 360 },
    ],
    walls: [
      { x: 320, y: 70, width: 24, height: 400 },
      { x: 616, y: 70, width: 24, height: 400 },
      { x: 448, y: 220, width: 48, height: 100 },
    ],
    playerSpawns: [
      { x: 360, y: 150 },
      { x: 360, y: 270 },
