...
const MAPS_UNSORTED: MapDefinition[] = [
  ...
  },
  {
    id: 'micro-channel',
    name: 'Micro Channel',
    description: 'Tiny map split by a short central channel, with three-unit squads per side.',
    width: 800,
    height: 450,
    lakes: [
      { x: 388, y: 142, width: 24, height: 166 },
    ],
    walls: [
      { x: 388, y: 112, width: 24, height: 22 },
      { x: 320, y: 210, width: 44, height: 30 },
      { x: 436, y: 210, width: 44, height: 30 },
      { x: 388, y: 316, width: 24, height: 22 },
    ],
    playerSpawns: [
      { x: 178, y: 190 },
      { x: 178, y: 260 },
