...
export const MAPS: MapDefinition[] = [
  ...
  },
  {
    ...
    description: 'Sector spawns, open-tipped triangle lakes at center, VIP bases at opposite corners.',
    width: 2048,
    height: 1152,
    lakes: [
      { x: 752, y: 260, width: 220, height: 90 },
      { x: 1076, y: 260, width: 220, height: 90 },
      { x: 752, y: 802, width: 220, height: 90 },
      { x: 1076, y: 802, width: 220, height: 90 },
      { x: 680, y: 356, width: 90, height: 180 },
      { x: 680, y: 616, width: 90, height: 180 },
      { x: 1278, y: 356, width: 90, height: 180 },
      { x: 1278, y: 616, width: 90, height: 180 },
    ],
    walls: [
      { x: 860, y: 220, width: 328, height: 20 },
      { x: 860, y: 912, width: 328, height: 20 },
      { x: 960, y: 340, width: 128, height: 18 },
      { x: 960, y: 794, width: 128, height: 18 },
      { x: 700, y: 300, width: 18, height: 180 },
      { x: 1330, y: 672, width: 18, height: 180 },
      { x: 1330, y: 300, width: 18, height: 180 },
      { x: 700, y: 672, width: 18, height: 180 },
    ],
    playerSpawns: [
      { x: 180, y: 980 },
      { x: 300, y: 920 },
