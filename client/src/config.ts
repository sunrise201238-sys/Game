...
export const TEAM_LOADOUT: string[] = ['soldier', 'soldier', 'soldier', 'archer', 'archer', 'archer', 'mage'];
...
export const MAPS: MapDefinition[] = [
  ...
  },
  {
    id: 'twin-bridge',
    name: 'Twin Bridge',
    description: 'Parallel canals separated by a central bridge flanked by cover.',
    width: 960,
    height: 540,
    lakes: [
      { x: 210, y: 80, width: 540, height: 120 },
      { x: 210, y: 340, width: 540, height: 120 },
    ],
    walls: [
      { x: 180, y: 70, width: 30, height: 140 },
      { x: 750, y: 70, width: 30, height: 140 },
      { x: 180, y: 330, width: 30, height: 140 },
      { x: 750, y: 330, width: 30, height: 140 },
